...
<!-- 自动添加 -->
<div id="prduct-img" class="ht-products product-slider-active owl-carousel owl-loaded owl-drag">
	<div class="owl-stage-outer" id="product-one">
				...
				<div class="ht-product-content">
					<div class="ht-product-content-inner">
						...
						<h4 class="ht-product-title">
							<a href="product-details.html">---产品名称---</a>
						</h4>
						<div class="ht-product-price">
							<span class="new">￥60.00</span><span class="old">￥80.00</span>
						</div>
						<div class="ht-product-ratting-wrap">
							<span class="ht-product-ratting"><span
								...
								class="sli sli-star"></i><i class="sli sli-star"></i><i
								class="sli sli-star"></i><i class="sli sli-star"></i></span>
						</div>
					</div>
				</div>
			</div>
